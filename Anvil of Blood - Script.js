...
function clickChar(charId) {
  ...
  if (charK.includes("WIGHT KING") === true || charN == "MARTIAL VAMPIRE LORD") {
...
function extendedAddToWS(theNameExt, wsPartExt, theTabExt, checkIdExt) {
  ...
  if (charK.innerHTML.includes("VAMPIRE") == true) {
    addToWS(Abi_The_Hunger, "abilities", theTabExt);
  };
...
var ohWs = ["ohW_01", "ohW_02", "ohW_03", "ohW_04", "ohW_05"]
var oh2s = ["oh2_01"]
...
function clickWea(checkId) {  
  ...
  if (document.getElementById("shi_01").checked == true) { addToWS(Ancient_Shield, "abilities", currentTab); };
  if (document.getElementById("shi_03").checked == true) { addToWS(Enchanted_Shield, "abilities", currentTab); };
  ...
  if (checkId.substring(0,3) == "ohW") {    
    ...
    if (bStar == true && checkBox.checked == true) { 
      ...
      if (checkBox.checked == true) {
        shi += 1;
        if (checkId != "shi_01") { document.getElementById("orgSave0" + currentTab).innerHTML = 1; };
      } else {
        shi -= 1;
...
function addCharEnh(checkId) {
  ...
  switch (enhancement) {
    ...
    case "Master of Dark Magics":  // increase or decrease number of spells
...
function spiritAddToWS(theNameExt, wsPartExt, theTabExt, checkIdExt) {
  ...
  if (document.getElementById("spH_01").checked == true) { 
    ...
    document.getElementById("abi_02").disabled = true; } 
  else if (document.getElementById("spH_01").checked == false) { 
    remFromWS(COMPANION, 'description');
    remFromWS(Frightful_Touch, 'abilities');
    var str = document.getElementById("heroKeys").innerHTML;
    if (str.includes("VAMPIRE") === true && document.getElementById("noB_01").checked == true) { 
      document.getElementById("abi_01").disabled = false;
      document.getElementById("abi_02").disabled = false; };
  };
...
// set restrictions by adding to warscroll------------------------------
function ext6AddToWS(theNameExt, wsPartExt, theTabExt, checkIdExt) {
  if (document.getElementById("abi_01").checked == true || document.getElementById("abi_02").checked == true) { 
    document.getElementById("spH_01").disabled = true;
    document.getElementById("spH_01a").disabled = true; }
  else { 
    document.getElementById("spH_01").disabled = false;
    if (document.getElementById("spH_01").checked == true) { document.getElementById("spH_01a").disabled = true; }
    else { document.getElementById("spH_01a").disabled = false; };
  };
  
  addToWS(theNameExt, wsPartExt, theTabExt, checkIdExt);
  
  // check if "FLY" is already shown
  document.getElementById("abi_06").disabled = true;
  var idCount = document.querySelectorAll('.warscroll [id*=Clone]').length;
  var flyCheck = false;
  if (idCount > 0) {
    for (c = 0; c < idCount; c++) {
  ...
  if (flyCheck == true || document.getElementById("abi_02").checked == true) { 
    document.getElementById("abi_06").disabled = false; } 
  else { 
    if (document.getElementById("abi_06").checked == true) {
      document.getElementById("abi_06").checked = false;
      var pointCell = document.getElementById("orgPts0" + currentTab);
      var addDP = document.getElementById("r1_abi_06c8").innerHTML;
      pointCell.innerHTML = parseInt(pointCell.innerHTML) - parseInt(addDP);
    };
    document.getElementById("abi_06").disabled = true; };
...
function checkAura() {
  ...
  var checkAura = document.getElementById("abi_12")   // Ethereal Nature
  ...
  if (cellV >= 4) { checkAura.disabled = false; }
    ...
    if (checkAura.checked == true) {
      ...
      remFromWS(Ethereal_Nature, 'abilities');   // Ethereal Nature
...
function resetRestrictionsStep6() {
  ...
  if (document.getElementById("gaB_01").checked == true) { 
    document.getElementById("abi_09").disabled = true;
    document.getElementById("abi_13").disabled = true; };
  if (document.getElementById("moB_01").checked == false) { 
    document.getElementById("abi_10").disabled = true; };
  if (str.includes("VAMPIRE") === false || document.getElementById("noB_01").checked == false) { 
    document.getElementById("abi_01").disabled = true;
    document.getElementById("abi_02").disabled = true; };
  
  checkAura();   // Ethereal Nature
